...
import { RegistrationRoles } from "@/lib/constants";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Role Selection Field using shadcn Select */}
          <div>
            <label className="block mb-1 font-medium text-gray-700">
              Account Type
            </label>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Select your account type. Tenants can book properties, Owners can list properties.
            </p>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#004087] text-white py-2 rounded-lg transition-colors font-semibold hover:bg-[#003066] disabled:opacity-50"
          >
